...
{
    private readonly PersonOptions personOptions = optPerson.Value;
    private readonly Clothing clothingOptions = optClothing.Value;
    private readonly Adjustments adjustmentOptions = optAdjustments.Value;
        ...
        string lon)
    {
        ...
        var list = CalculateClothing(people, weather, personOptions.Intensities);
    ...
    private IntensityClothing GetClothingForAdjustedTemp(double adjustedTemp, Enums.Intensity intensity, string conditions, Enums.TimeOfDay timeOfDay)
    {
        ...
        FindCorrectItemForBodyPart(adjustedTemp, intensity, conditions, timeOfDay, clothingOptions.Head, ref finalList);
        FindCorrectItemForBodyPart(adjustedTemp, intensity, conditions, timeOfDay, clothingOptions.InnerTorso, ref finalList);
        FindCorrectItemForBodyPart(adjustedTemp, intensity, conditions, timeOfDay, clothingOptions.OuterTorso, ref finalList);
        FindCorrectItemForBodyPart(adjustedTemp, intensity, conditions, timeOfDay, clothingOptions.Legs, ref finalList);
        FindCorrectItemForBodyPart(adjustedTemp, intensity, conditions, timeOfDay, clothingOptions.Hands, ref finalList);
    ...
    private double FeelAdjustment(Enums.Feel feel)
    {
        ...
        switch (feel)
        {
            case Enums.Feel.Cool:
                feelAdjustment = adjustmentOptions.Feel.Cool;
                break;
            case Enums.Feel.Warm:
                feelAdjustment = adjustmentOptions.Feel.Warm;
                break;
        }
    ...
    private double IntensityAdjustment(Enums.Intensity intensity)
    {
        ...
        switch (intensity)
        {
            case Enums.Intensity.Race:
                intensityAdjustment = adjustmentOptions.Intensity.Race;
                break;
            case Enums.Intensity.Workout:
                intensityAdjustment = adjustmentOptions.Intensity.HardWorkout;
                break;
            case Enums.Intensity.Long:
                intensityAdjustment = adjustmentOptions.Intensity.LongRun;
                break;
        }
    ...
    private double WindTemperatureAdjustment(WeatherItem weather)
    {
        ...
        switch (windType)
        {
            case Enums.WindType.Light:
                windAdjustment = adjustmentOptions.Wind.LightWind;
                break;
            case Enums.WindType.Medium:
                windAdjustment = adjustmentOptions.Wind.Windy;
                break;
            case Enums.WindType.Heavy:
                windAdjustment = adjustmentOptions.Wind.HeavyWind;
                break;
        }
    ...
    {
        var wind = adjustmentOptions.WindSpeed;
    ...
    private double TimeOfDayAndPrecipitationTempAdjustment(WeatherItem weather)
    {
        ...
        switch (weather.TimeOfDay)
        {
            case Enums.TimeOfDay.Day:
                ...
                {
                    case "Clear":
                        timeOfDayAndConditionsAdjustment += adjustmentOptions.TimeofdayPrecipitation.ClearDay;
                        break;
                    case "Clouds":
                    case "Mist":
                        timeOfDayAndConditionsAdjustment += adjustmentOptions.TimeofdayPrecipitation.PartiallyCloudyDay;
                        break;
                }
                break;
            ...
            case Enums.TimeOfDay.Dusk:
                ...
                {
                    case "Clear":
                        timeOfDayAndConditionsAdjustment += adjustmentOptions.TimeofdayPrecipitation.ClearDuskDawn;
                        break;
                    case "Clouds":
                    case "Mist":
                        timeOfDayAndConditionsAdjustment += adjustmentOptions.TimeofdayPrecipitation.PartiallyCloudyDuskDawn;
                        break;
                }
                break;
            default:
                ...
                {
                    case "Rain":
                        timeOfDayAndConditionsAdjustment += adjustmentOptions.TimeofdayPrecipitation.Rain;
                        break;
                    case "Drizzle":
                        timeOfDayAndConditionsAdjustment += adjustmentOptions.TimeofdayPrecipitation.LightRain;
                        break;
                    case "Snow":
                        timeOfDayAndConditionsAdjustment += adjustmentOptions.TimeofdayPrecipitation.Snow;
                        break;
                }
                break;
        }
    ...
    {
        return personOptions.BodyParts;
    }
